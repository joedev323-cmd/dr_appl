...
public class DoctorController {
    ...
    public String updateDoctor(@PathVariable Long id, @ModelAttribute("doctor") Doctor doctorDetails,
            RedirectAttributes ra) {
        Doctor existingDoctor = doctorRepository.findById(id).orElseThrow();

        // Update specific fields (Keep the Admin/Doctor status logic separate or
        // include it here)
